...
import { updateDeliveryOrderStatus } from '../../services/itemService';
import { ChevronDown, ChevronUp } from 'lucide-react';

const DeliveryOrdersTable = ({ orders, onOrderUpdated }) => {
          ...
          {orders.map((order) => (
            <React.Fragment key={order.id}>
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-2 text-sm">{order.phone_number}</td>
                        ...
                        <div className="bg-white rounded border border-gray-200 p-3 space-y-2">
                          ...
                          <div className="border-t border-gray-200 pt-2 mt-2 space-y-1">
                            <div className="flex justify-between">
                              <span>Subtotal</span>
                              <span className="text-amber-700 font-medium">{formatPeso(order.subtotal)}</span>
                            </div>
                            <div className="flex justify-between">
                              <span>Delivery Fee</span>
                              <span className="text-amber-700 font-medium">{formatPeso(order.delivery_fee)}</span>
                            </div>
